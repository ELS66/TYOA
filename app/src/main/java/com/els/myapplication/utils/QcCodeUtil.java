...
//        QRCodeUtil.insertImage(image, logoImgPath, needCompress);
        ...
        public static Bitmap createImage(String content,String title) {
            int picWidth = 600;//生成图片的宽度
            int picHeight = 600;//生成图片的高度
            int titleTextSize = 30;
            int contentTextSize = 30;
            ...
            canvas.drawBitmap(image,(picWidth-qrWidth)/2,qrTop-20,paint);
            ...
            int textTop = qrTop+qrHeight+paddingBottom-50;//地址的顶部高度
